...
// Passing a minimal wardrobe payload upward; parent composes full object
...
interface CreateWardrobeModalProps {
  ...
  onSave: (wardrobe: NewWardrobePayload) => void;
}

export function CreateWardrobeModal({
  open,
  onOpenChange,
  onSave,
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (!res.ok) {
        throw new Error("Failed to create wardrobe");
      }
        ...
        <div className="space-y-4">
            ...
            <div className="border-2 border-dashed border-muted-foreground/25 rounded-lg p-6 text-center">
              <div className="flex flex-col items-center gap-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Upload a cover image or leave blank to use the first outfit
                  added
                </p>
                {coverImage && (
                  <Image
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              placeholder="Describe the theme or style of this wardrobe..."
              maxLength={200}
              rows={3}
            />
            <p className="text-xs text-muted-foreground">
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-1">
              ...
              <p className="text-xs text-muted-foreground">
                Others can discover and follow this wardrobe
              </p>
            </div>
            <Switch
              id="public"
