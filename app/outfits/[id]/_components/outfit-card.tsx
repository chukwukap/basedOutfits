...
export function OutfitCard({ outfit, onTip, onCollect }: OutfitCardProps) {
      ...
      <div className="p-4 space-y-3">
        ...
        <div className="flex items-center gap-3">
          <Avatar className="w-9 h-9 ring-2 ring-background">
            <AvatarImage src={outfit.author.avatarUrl || "/placeholder.svg"} />
            <AvatarFallback className="text-xs">
              {outfit.author.name[0]}
            </AvatarFallback>
          </Avatar>
          <div className="flex-1 min-w-0">
            <p className="font-medium text-sm truncate">{outfit.author.name}</p>
