...
export function TipModal({ open, onOpenChange, look, onComplete }: TipModalProps) {
        ...
        <div className="space-y-4">
          ...
          {paymentState === "input" && (
            <>
              ...
              <div className="flex gap-2 pt-2">
                ...
                <Button onClick={handleContinue} disabled={Number.parseFloat(amount) < 0.5} className="flex-1">
                  Continue
                </Button>
              </div>
            </>
          ...
          {paymentState === "method" && (
            <>
              ...
              <div className="flex gap-2 pt-2">
                <Button variant="outline" onClick={() => setPaymentState("input")} className="flex-1">
                  Back
                </Button>
