...
import { Heart, DollarSign, MapPin, Calendar, Users, Palette, Sparkles } from "lucide-react"
  ...
  return (
    <div>
      ...
      <div className="p-4 space-y-6">
        ...
        <Card className="p-4">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-muted-foreground mb-2 line-clamp-2">{look.author.bio}</p>
        ...
        {/* Full Description */}
        <div>
          <p className="text-muted-foreground leading-relaxed text-base">{look.description}</p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          {look.season && (
            <div>
              <h5 className="font-medium text-sm text-muted-foreground mb-1">Season</h5>
              <p className="text-sm">{look.season}</p>
            </div>
          )}
          {look.occasion && (
            <div>
              <h5 className="font-medium text-sm text-muted-foreground mb-1">Occasion</h5>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {look.colors.map((color) => (
                <Badge key={color} variant="outline" className="text-sm px-3 py-1">
                  {color}
                </Badge>
              ))}
            </div>
