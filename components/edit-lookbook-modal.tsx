...
export function EditLookbookModal({ open, onOpenChange, lookbook, onSave }: EditLookbookModalProps) {
          ...
          <div className="space-y-2">
            ...
            <div className="border-2 border-dashed border-muted-foreground/25 rounded-lg p-6 text-center">
              <div className="flex flex-col items-center gap-2">
                ...
                <p className="text-sm text-muted-foreground">Upload a new cover image or keep current</p>
